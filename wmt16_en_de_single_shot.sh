...
fairseq-train $DATA_DIR \
    --user-dir 'single_shot' \
    --task single_shot_translation \
    --arch transformer_single_shot --share-all-embeddings \
    ...
    --criterion single_shot_loss --label-smoothing 0.1 \
    ...
    --no-epoch-checkpoints --log-format simple --log-interval 10 --num-workers 20\
