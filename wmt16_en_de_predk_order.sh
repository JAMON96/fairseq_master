...
fairseq-train $DATA_DIR \
    --user-dir 'predk' \
    --task predk_translation --max-shuffle-distance 16 \
    --arch transformer_predk --share-all-embeddings \
    ...
    --no-epoch-checkpoints --log-format simple --log-interval 10 --num-workers 30\
