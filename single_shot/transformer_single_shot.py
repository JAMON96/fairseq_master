...
from fairseq.models import (
    FairseqEncoder, FairseqDecoder,
    FairseqEncoderDecoderModel,
    FairseqIncrementalDecoder,
    register_model,
    register_model_architecture,
)
from single_shot.single_shot_multi_head_attention import *
...
class SingleShotTransformerDecoderLayer(TransformerDecoderLayer):
    """Decoder layer block.
    ...
    *args.decoder_normalize_before* to ``True``.
    ...
    def build_encoder_attention(self, embed_dim, args):
        return SingleShotMultiheadAttention(
            embed_dim,
    ...
    def forward(
        ...
        if self.encoder_attn is not None:
            ...
            x, attn, q_raw = self.encoder_attn(
                query=x,
                key=x,
                value=x,
...
class SingleShotTransformerModel(SingleShoeFairseqEncoderDecoderModel):
    ...
    def build_model(cls, args, task):
        ...
        if args.share_all_embeddings:
            ...
            args.share_de   coder_input_output_embed = True
        else:
            encoder_embed_tokens = cls.build_embedding(
                args, src_dict, args.encoder_embed_dim, args.encoder_embed_path
            )
...
class TransfomerSingleShot(SingleShotTransformerModel):
    ...
    def build_encoder(cls, args, tgt_dict, embed_tokens):
        return SingleShotTransformerEncoder(args, tgt_dict, embed_tokens)

    @classmethod
    def build_decoder(cls, args, src_dict, embed_tokens):
        return SingleShotTransformerDecoder(args, src_dict, embed_tokens)
    ...
    def forward(
        ...
        decoder_out, q_raws = self.decoder(
            src_tokens
            )

        return decoder_out, encoder_out, q_raws
